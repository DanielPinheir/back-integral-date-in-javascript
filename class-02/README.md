...
Given the following list of people, who registered with different companies on different dates, we need you to order this list from oldest to newest registrations.
Use the `sort()` method.
